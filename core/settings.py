...
# 'u2netp' is the lightweight/fast rembg model (default — good speed/quality
# balance for a live website). Set REMBG_MODEL=u2net in .env for the heavier,
# more accurate model if you don't mind a slower response per image.
REMBG_MODEL = config('REMBG_MODEL', default='u2netp')
